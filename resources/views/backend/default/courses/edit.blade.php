...
@section('content')
    <div class="page-header">
        <div class="row align-items-center bg-white p-2">
            <div class="col">
                <h4 class="text-capitalize mt-3 mb-0">Update Course</h4>
            </div>
    ...
    {{ Form::open(['method' => 'PUT', 'route' => ['course.update', $course], 'files' => 'true', 'enctype' => 'multipart/form-data',]) }}
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}"  value="{{ $course->title }}" required>
                                    @if ($errors->has('title'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="teacher" class="form-control form-select {{ $errors->has('teacher') ? 'is-invalid' : '' }}" required>
                                            ...
                                            @foreach($teachers as $teacher)
                                                <option value="{{ $teacher->id  }}" {{ ($course->techer_id == $teacher->id) ? 'selected' : '' }}>{{$teacher->full_name }} </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea rows="5" cols="10" name="description" id="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" style="height: 150px">{{ $course->description }}</textarea>
                ...
                <div class="card-body">
                    <div class="file-upload">
                        ...
                        <div class="file-preview">
                            ...
                            @else
                                <img id="image-preview" style="background-image: url({{ asset('public/uploads/defaults/image-not-found.jpg')}});"/>
                            @endif
                        </div>
                    </div>
                </div>
